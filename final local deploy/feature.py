...
class FeatureExtraction:
    ...
    def __init__(self,url):
        ...
        self.features.append(self.Statstical_report())
    ...
    def Page_Rank(self):
        try:
            prank_checker_response = requests.post("https://www.checkPage_Rank.net/index.php", {"name": self.domain})
